...
class GaugeDecoration {
  ...
  const GaugeDecoration({
    this.arrowColor = _arrowColor,
    this.arrowPaintingStyle = _arrowPaintingStyle,
    this.arrowEndShift = _arrowEndShift,
    this.arrowStartWidth = _arrowStartWidth,
    this.tickColor = _tickColor,
    this.tickWidth = _tickWidth,
    this.textStyle = _valueTextStyle,
    this.rangeWidth = _rangeWidth,
    this.ticksCount = _ticksCount,
    this.ticksPerSection = _tickPerSection,
    this.baselineColor = _baselineColor,
    this.baselineWidth = _baselineWidth,
    this.baselinePaintingStyle = _baselinePaintingStyle,
    this.backgroundColor = _backgroundColor,
    this.limitArrowHeight = _limitArrowHeight,
    this.limitArrowWidth = _limitArrowWidth,
    this.limitArrowColor = _limitArrowColor,
    this.limitArrowPaintingStyle = _limitArrowPaintingStyle,
